...
angular.module('users')
    .directive('userSearch',['$timeout',"$http","Authentication",function($timeout,$http,Authentication){
        return {
            restrict:'E',
            replace:true,
            ...
            link : function(scope,element,attr) {
                ...
                scope.search = function() {
                    ...
                    $http.get("/api/users/search/"+scope.searchText).then(function success(res) {
